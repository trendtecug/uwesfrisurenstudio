...
The API of the 0.5.x versions has changed. Because several extensions depend 
on this library it will not be migrated to the 0.5.x versions. So this is a
final release, stable, not obsolete, but it wont be migrated to the 0.5.x
version. 

This means, if you want to use a current release of xajax, you have to select
different extension. 
